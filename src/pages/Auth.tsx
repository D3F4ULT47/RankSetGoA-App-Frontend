...
import { setUserLoggedIn } from "@/components/Header";
...
const Auth = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === "register") {
        const res = await fetch("https://ranksetgoa-app-backend.onrender.com/api/v1/user/register", {
          method: "POST",
        ...
        if (!res.ok) {
          ...
          let errorMessage = "Registration failed here Go Back to SignUp page";
      ...
      // Sign-in logic
      if (mode === "signin") {
        const res = await fetch("https://ranksetgoa-app-backend.onrender.com/api/v1/user/login", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
          body: JSON.stringify({
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/5 via-primary/10 to-accent/10 p-12 flex-col justify-center items-center">
        <div className="max-w-md text-center">
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="w-14 h-14 rounded-xl bg-primary flex items-center justify-center">
              <GraduationCap className="w-8 h-8 text-primary-foreground" />
            </div>
            <span className="text-3xl font-bold text-foreground">RankSetGo</span>
          </div>

          <h1 className="text-4xl font-bold text-foreground mb-4">
            Welcome to RankSetGo
          </h1>

          <p className="text-lg text-muted-foreground mb-8">
            Predict colleges, get personalised guidance, and receive expert JoSAA
            ...
            <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-3 w-24 mx-auto bg-primary/15 rounded-full" />
                  <div className="h-3 w-28 mx-auto bg-primary/10 rounded-full" />
                </div>
              </div>
            </div>
          </div>
